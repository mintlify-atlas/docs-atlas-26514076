---
title: Streaming
description: Stream AI responses in real-time using Server-Sent Events, Vercel AI SDK integration, or WebSocket broadcasting
---
...
For more information about creating tools that produce artifacts, see [Tool artifacts](/core-concepts/tools#tool-artifacts).
