...
description: Get AI responses in structured formats with schema validation, perfect for building APIs and processing data
---
...
See the [Text generation](./text-generation) documentation for comparison with standard text generation capabilities.
...
For more information about tools and function calling, see the [Tools & function calling](./tools) documentation.
