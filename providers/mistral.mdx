---
title: 'Mistral'
description: 'Magistral reasoning models with advanced audio processing and OCR capabilities'
---
...
See the [Documents](/core-concepts/text-generation#multi-modal-input) page on how to do that.
